...
?
  ...
  #DEFINE LED LATB,5 ;Definimos el pin 5 de salida 
...
MAIN		
    BTG	    LED		;1CM Cambiamos el valor del led al contrario pero solo en
                        ;un bit	
    CALL    DELAY_100mS	;Llamamos a nuestro delay
